...
typedef union
{
  struct
  {
    ...
    uint16_t is_cluster_operational_1;
    uint16_t is_cluster_operational_2;
...
typedef union
{
  struct
  {
    ...
    uint16_t station_current;
    uint16_t station_soc;
    uint16_t station_soh;
    uint16_t station_charge_capacity;
    uint16_t station_discharge_capacity;
    uint16_t station_single_charge_capacity;
    uint16_t station_single_discharge_capacity;
    uint16_t station_cumulative_charge;
    uint16_t station_cumulative_discharge;
    uint16_t station_cell_vol_delta;
    uint16_t max_single_cell_vol;
    uint16_t min_single_cell_vol;
    uint16_t station_cell_temp_delta;
    uint16_t max_single_cell_temp;
    uint16_t min_single_cell_temp;
    uint16_t cluster_soc_delta;
    uint16_t max_cluster_soc;
    uint16_t min_cluster_soc;
    uint16_t cluster_vol_delta;
    uint16_t max_cluster_vol;
    uint16_t min_cluster_vol;
    uint16_t station_max_charging_power;
    uint16_t station_max_discharging_power;
    uint16_t station_max_charging_current;
    uint16_t station_max_discharging_current;
  } data;
