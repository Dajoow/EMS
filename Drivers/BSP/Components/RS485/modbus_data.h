...
typedef union{
  struct {
    ...
    uint8_t clus_chg_curr_high_warn;
    uint8_t clus_disch_curr_high_warn;
    uint8_t cell_v_high_warn;
    uint8_t cell_v_low_warn;
    uint8_t clus_chg_temp_high_warn;
    uint8_t clus_chg_temp_low_warn;
    uint8_t clus_disch_temp_high_warn;
    uint8_t clus_disch_temp_low_warn;
    uint8_t cell_temp_high_warn;
    uint8_t cell_temp_low_warn;
    uint8_t ambient_temp_high_warn;
    uint8_t ambient_temp_low_warn;
    uint8_t powerline_temp_high_warn;
    uint8_t clus_soc_high_warn;
    uint8_t clus_soc_low_warn;
    uint8_t pos_insul_res_low_warn;
    uint8_t neg_insul_res_low_warn;
